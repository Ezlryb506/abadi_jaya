...
export const metadata: Metadata = {
  title: 'Harga Railing di Bekasi 2025 — Estimasi & Tips | Abadi Jaya',
  description: 'Panduan lengkap harga railing di Bekasi 2025. Estimasi biaya, tips memilih material, dan rekomendasi bengkel las terpercaya.',
  keywords: [
    'harga railing bekasi',
    'estimasi biaya railing bekasi',
    'bengkel las railing bekasi',
    'jasa railing bekasi',
    'railing minimalis modern bekasi',
    'harga railing per meter bekasi',
    'kontraktor railing bekasi'
  ],
  alternates: {
    canonical: '/blog/harga-railing-bekasi-2025'
  },
  openGraph: {
    title: 'Harga Railing di Bekasi 2025 — Estimasi & Tips | Abadi Jaya',
    description: 'Panduan lengkap harga railing di Bekasi 2025. Estimasi biaya, tips memilih material, dan rekomendasi bengkel las terpercaya.',
    type: 'article',
    url: '/blog/harga-railing-bekasi-2025',
    images: [{
      url: '/api/og?variant=blog&title=Harga%20Railing%20Bekasi%202025'
    }]
  }
};
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Berapa harga railing per meter di Bekasi?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Harga railing di Bekasi berkisar Rp 350.000 - Rp 700.000 per meter, tergantung material dan desain.'
      }
    },
    {
      '@type': 'Question',
      name: 'Material railing apa yang paling awet di Bekasi?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Material terbaik untuk railing di Bekasi adalah besi hollow galvanis dan stainless steel untuk hasil premium.'
      }
    }
  ]
};
...
const articleJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Article',
  headline: 'Harga Railing di Bekasi 2025 — Estimasi & Tips',
  description: 'Panduan lengkap harga railing di Bekasi 2025. Estimasi biaya, tips memilih material, dan rekomendasi bengkel las terpercaya.',
  author: {
    '@type': 'Organization',
    name: 'Abadi Jaya',
  ...
  mainEntityOfPage: 'https://abadi-jaya.vercel.app/blog/harga-railing-bekasi-2025',
  image: 'https://abadi-jaya.vercel.app/api/og?variant=blog&title=Harga%20Railing%20Bekasi%202025'
};

export default function HargaRailingBekasi2025() {
  return (
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          <nav className="text-orange-100 text-sm mb-3">
            ...
            <span className="opacity-90">Harga Railing Bekasi 2025</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Harga Railing di Bekasi 2025 — Estimasi & Tips
          </h1>
          <p className="text-orange-100 text-lg">
            Panduan lengkap estimasi biaya railing di Bekasi. Tips memilih material, contoh desain, dan rekomendasi bengkel las terpercaya.
          </p>
        </div>
      </div>
        ...
        <Card className="mb-10 p-8">
          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              Estimasi Harga Railing di Bekasi 2025
            </h2>
            <p className="text-gray-700 mb-6">
              Railing menjadi elemen penting untuk keamanan dan estetika rumah di Bekasi. Dengan desain minimalis dan material berkualitas, railing memberikan perlindungan optimal dan tampilan modern.
            </p>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              Tabel Harga Railing per Meter
            </h3>
              ...
              <table className="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2 font-semibold text-orange-600">Rp 700.000</td>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              Tips Memilih Railing di Bekasi
            </h3>
            ...
            <ContohProyekBlog kategori="Railing" area="Bekasi" />
            <h3 className="text-xl font-semibold text-gray-900 mb-4">
              Konsultasi Gratis Railing di Bekasi
            </h3>
            <p className="mb-4">
              Ingin mendapatkan estimasi harga yang akurat untuk proyek railing Anda? Tim Abadi Jaya siap membantu dengan survey gratis ke lokasi proyek.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              <a 
                href="https://wa.me/6289653754317?text=Halo%2C%20saya%20ingin%20konsultasi%20untuk%20railing%20di%20Bekasi" 
                target="_blank" 
